...
public class SignupThree extends JFrame implements ActionListener {
	...
	SignupThree(String formno)
	{
		...
		r2 =new JRadioButton("Fixed Depoait Account");
		...
		JLabel number= new JLabel("xxxx-xxxx-xxxx-124");
		...
		JLabel services= new JLabel("Services Requride");
		services.setFont(new Font("Releway" ,Font.BOLD ,22));
		services.setBounds(100, 450, 200, 30);
		add(services);
		
		c1= new JCheckBox("ATMCARD");
		...
		c7= new JCheckBox("I Hereby declares that the above enterde details are correct to the best of my knowledge");
...
//			}
			...
			{
				accounttype=" Fixed Depoait Account";
			}
			...
			try {
				...
				{
					JOptionPane.showMessageDialog(null, "Account Type is Requride");
				}else 
				{
				Conn conn= new Conn();
